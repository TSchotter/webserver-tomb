...
20. [Common MySQL Commands](5-database/mysqlCommands.md)
21. [MySQL JOINs](5-database/mysqlJoins.md)
22. [Aggregate Functions and GROUP BY](5-database/mysqlAggregateFunctions.md)

## Server Setup

23. [Server Setup Overview](6-server-setup/index.md)
24. [Essential Server Security](6-server-setup/essential-security.md)
25. [GitHub Terminal Connection](6-server-setup/github-terminal-connection.md)
26. [Docker and nginx](6-server-setup/docker-nginx.md)
27. [Docker and Node.js](6-server-setup/docker-and-nodejs.md)
28. [Setting Up nginx with Docker and Node.js](6-server-setup/docker-nginx-setup.md)

## Cookies and Sessions

29. [Cookies and Sessions Overview](7-cookies-sessions/index.md)
30. [Client-Side Cookies with Forms](7-cookies-sessions/client-side-cookies.md)
31. [Server-Side Sessions](7-cookies-sessions/server-side-sessions.md)

## REST API Principles

32. [REST API Overview](8-rest-api/index.md)
33. [What is REST?](8-rest-api/what-is-rest.md)

## Database Server Setup

34. [Database Server Setup Overview](9-sqlite3-server/index.md)
35. [Setting Up SQLite Database](9-sqlite3-server/sqlite3-server-setup.md)
36. [Connecting SQLite to Node.js Express](9-sqlite3-server/sqlite3-nodejs-express.md)
