---
layout: default
title: Creating Your Own Node.js Modules
nav_order: 10
---
...
- Completed [NodeJS Modules and NPM](../3-nodejs/nodejsModules.md)
- Basic familiarity with Node.js

## Quick Start

Start with [Module Basics](module-basics.md) to learn how to create your first module.

---

**[Previous: Database Server Setup](../9-mysql-server/index.md)** | **[Next: Module Basics](module-basics.md)**
